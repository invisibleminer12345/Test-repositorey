...
//        arm.setPower(MotorType.PRIMARY, -0.14);
        sleep(300);
        if (opModeIsActive()) {
//            this.drivetrainHandler.Forward(500, -0.4);
            this.fieldCentricPowerVectorMovement(0.5, -0.35, 0);
            sleep(1750);
            this.drivetrainHandler.stopMotors();
            sleep(300);
            this.arm.extendArm();
            ...
            sleep(500);
            this.drivetrainHandler.stopMotors();
            arm.changePosition(-350, 1);
//            this.arm.setPower(MotorType.PRIMARY, 0.75);
//            sleep(750);
//            this.arm.setPower(MotorType.PRIMARY, 0);
//            this.fieldCentricPowerVectorMovement(0, 0.5, 0);
            sleep(200);
            this.arm.contractArm();
            sleep(500);
            this.claw.open();
            //            this.drivetrainHandler.stopMotors();
            sleep(500);
...
//            arm.setPower(MotorType.PRIMARY, -0.1);
            this.fieldCentricPowerVectorMovement(-0.55, 0.15, 0);
            sleep(3000);
            this.fieldCentricPowerVectorMovement(0.3, -0.425, 0);
            sleep(2000);
            this.fieldCentricPowerVectorMovement(0.3, 0, 0.35);
            sleep(1000);
...
//            this.drivetrainHandler.Forward(200, 0.2);
//            sleep(1000);
//            this.drivetrainHandler.Right(50, 0.2);
//            this.endAuto();
        }
    }
