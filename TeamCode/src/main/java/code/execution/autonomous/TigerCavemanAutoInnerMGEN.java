...
@Autonomous(name = "Tiger Caveman Auto -- INNER VER -- USE THIS ONE", group = "AUTO")
public class TigerCavemanAutoInnerMGEN extends TigerCavemanAutoBase {
...
//        arm.changePosition(567, 0.4);
        ...
        sleep(300);
        super.arm.setExtension(-300, 0.9);
        claw.open();
        sleep(300);
        claw.setWristPos(0.8);
        this.drivetrainHandler.stopMotors();
        super.arm.setExtension(-800, 0.9);
//        arm.changePosition(-200-369-31, 1);
    ...
    private void park() {
        ...
        this.fieldCentricPowerVectorMovement(1, 0.05, 0);
        sleep(2500);
        this.drivetrainHandler.stopMotors();
        this.endAuto();
    }
